...
\begin{twocolentry}{
		\href{https://xplorepk.com/}{GitHub}
	}{
...
\end{twocolentry}
\vspace{1em}
% Media Display and Sender Apps
\begin{twocolentry}{
		\href{https://github.com/rogueinnovator/IOTBoardMediaUploader}{GitHub}
	}{
		\textbf{VIII. Media Display and Sender Apps}
	}
	\begin{highlights}
		\item Created two client applications to manage and display media on Android TV boxes.
		\item Developed a Media Display App to show content with title and timestamps, supporting automatic and manual media deletion.
		\item Built a Media Sender App enabling users to select and send media to specific devices through Firebase in real-time.
		\item Implemented secure user authentication and data transmission.
		\item \textbf{Technologies:} Next.js, Firebase, Tailwind CSS, Node.js, TypeScript.
	\end{highlights}
\end{twocolentry}
\section{Education}
